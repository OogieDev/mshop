                ...
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price" id="base-price" data-base="<?= $curr['symbol_left'] ?><?= $product->price * $curr['value'];?> <?= $curr['symbol_right'] ?>"><?= $curr['symbol_left'] ?><?= $product->price * $curr['value'];?> <?= $curr['symbol_right'] ?>
                    ...
                    <div class="product-one">
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <h4>
                                        ...
                                        <span class="item_price"><?= $curr['symbol_left'] ?><?= $item['price'] * $curr['value'];?> <?= $curr['symbol_right'] ?>
                            ...
                            <span>
                                -
                                <?php echo floor(abs(
                                    (($item['old_price'] * $curr['value']) - ($item['price'] * $curr['value']))
                                    /
                                    ((($item['old_price'] * $curr['value']) + ($item['price'] * $curr['value'])) / 2) * 100
                                )); ?>
                                %
                            </span>
                                    </div>
